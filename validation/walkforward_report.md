...
Engine `sha256:c12adfb15c04adcd` · git `c363b2184194` · 127 folds over 143 books (burn-in 15) · skipped {'POOL_LT_BURN_IN': 15, 'SKIPPED_NO_CACHE': 1}.
...
| variant | WA MAE |
| --- | --- |
| raw (no correction) | 0.778 |
| honest — memory-only (pre-refine) | 0.589 |
| leaky (today's config) | 0.544 |
| hybrid (LIVE served) | 0.557 |
...
| --- | --- | --- | --- |
| raw (no correction) | 0.462 | 0.313 | 127 |
| honest — memory-only (pre-refine) | 0.715 | 0.528 | 127 |
| leaky (today's config) | 0.805 | 0.610 | 127 |
| hybrid (LIVE served) | 0.750 | 0.563 | 127 |
...
| Science Fiction (Soft) | 13 | 0.753 | 0.703 | 0.460 | -0.050 |
| Classical Drama | 2 | 1.088 | 0.754 | 0.680 | -0.334 |
| Speculative Literary Fiction | 2 | 1.106 | 0.985 | 0.809 | -0.121 |
...
| --- | --- | --- | --- | --- |
| 2025 | 58 | 0.941 | 0.707 | 0.667 |
| 2026 | 69 | 0.640 | 0.491 | 0.440 |
...
| last | 143 | 0.410 | 0.395 | 0.669 |

## Component MAE — worst first  (WB rows with actual=0 sentinel excluded)

| component | n | raw | honest | leaky | Δ honest−raw |
| --- | --- | --- | --- | --- | --- |
| Ending | 127 | 1.298 | 1.156 | 1.150 | -0.142 |
| Emotional Impact | 127 | 1.138 | 1.025 | 0.967 | -0.113 |
| Motivations | 127 | 0.996 | 0.843 | 0.793 | -0.153 |
| Narration | 127 | 0.986 | 0.839 | 0.747 | -0.147 |
| Integration *(WB)* | 113 | 0.928 | 0.836 | 0.801 | -0.092 |
| Action | 127 | 0.874 | 0.813 | 0.766 | -0.061 |
| Depth2 *(WB)* | 113 | 0.792 | 0.801 | 0.653 | 0.009 |
| Plot | 127 | 0.919 | 0.795 | 0.679 | -0.124 |
| Depth | 127 | 0.946 | 0.794 | 0.705 | -0.152 |
| Originality *(WB)* | 113 | 0.943 | 0.787 | 0.643 | -0.156 |
| Thought-Provokingness | 127 | 0.882 | 0.777 | 0.705 | -0.105 |
| Entertainment | 127 | 0.884 | 0.776 | 0.708 | -0.108 |
| Insights | 127 | 0.835 | 0.710 | 0.678 | -0.124 |
| Prose | 127 | 0.823 | 0.643 | 0.543 | -0.180 |
...
| honest — memory-only (pre-refine) | 34.6% | 127 | -55.4% |
| leaky (today's config) | 29.9% | 127 | -60.1% |
| hybrid (LIVE served) | 33.9% | 127 | -56.1% |
...
| --- | --- | --- | --- |
| honest errors vs `calibration/residuals.json` | 82.7% | 127 | -7.3% |
...
| 60 | Station 11 | Science Fiction (Sof | 59 | 5.20 | 7.92 | 2.72 | genre | 0/7 |
| 74 | The Last Shadow | Science Fiction (Har | 73 | 3.78 | 6.41 | 2.63 | author | 6/8 |
| 83 | Ready Player One | Science Fiction (Sof | 82 | 4.51 | 7.11 | 2.60 | genre | 0/14 |
...
| 107 | The Fifth Season | Science Fiction (Sof | 106 | 6.90 | 8.44 | 1.53 | genre | 0/15 |

## Raw → corrected: where the correction helps / hurts

- Genres where the walk-forward correction **beats raw**: 9 (best: Literary Fiction, Science Fantasy, Classical Drama).
- Genres where it **hurts vs raw**: 2 (Literary Fantasy, Science Fiction (Hard)).
- Overall, honest correction changes WA MAE by **-0.188** vs raw (negative = correction helps).
...
| The Rise of Endymion | 2026-07-07 | 7.91 | 7.74 | 7.75 | 7.73 | evaluated (pos 128) |
