...
Engine `sha256:681f0e6a4fd83f53` · git `9d8640c025d1` · 114 folds over 129 books (burn-in 15) · skipped {'BURN_IN': 15}.
...
| honest (walk-forward) | 0.635 |
| leaky (today's config) | 0.607 |
...
| Epic Fantasy | 51 | 0.750 | 0.494 | 0.548 | -0.256 |
...
| --- | --- | --- | --- | --- |
| 2025 | 66 | 0.905 | 0.698 | 0.651 |
| 2026 | 48 | 0.730 | 0.547 | 0.546 |
...
| Depth2 *(WB)* | 101 | 0.840 | 0.774 | 0.711 | -0.065 |
...
| honest (walk-forward) | 31.6% | 114 | -58.4% |
| leaky (today's config) | 30.7% | 114 | -59.3% |
...
- Overall, honest correction changes WA MAE by **-0.197** vs raw (negative = correction helps).
